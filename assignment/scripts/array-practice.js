...
let favoriteFoods = ["pizza", "tacos", "soup", "burritos"];

// 1.b. TODO: Log your array of foods to the console with a message, similar 
//      to the example above

console.log('My favorite foods are', favoriteFoods.join());
...
console.log('The last food,', removedFood,', was removed');
...
console.log(`Removed a favorite food from the beginning: ${favoriteFoods}`);

// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.

favoriteFoods[1] = "rice";
console.log(`Updated my second favorite food: ${favoriteFoods}`);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.

favoriteFoods.reverse();
console.log(`My favorite foods in reverse order: ${favoriteFoods}`);
